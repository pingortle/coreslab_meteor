...
Router.map(function() {
	...
	this.route('project_element', {
		...
		data: function() {
			return Pieces.find(
				{ projectID: this.params.id, projectElementID: this.params.element },
				{ sort:[["projectID", "desc"], ["projectElementID", "asc"]] });
		},
		onAfterAction: function() {
			Session.set('breadcrumbs', [
				{ title: 'Projects', route: 'projects' },
				{ title: this.params.id, route: 'project', id: this.params.id },
				{title: this.params.element },
			]);
		},
	});
	...
	this.route('new_piece', {
		...
		onAfterAction: function() {
			Session.set('breadcrumbs', [
				{ title: 'Projects', route: 'projects' },
				{ title: this.params.id + '.' + this.params.element , route: 'project', id: this.params.id },
				{ title: 'New Piece' },
			]);
		},
	});
	...
	this.route('edit_piece', {
		...
		onAfterAction: function() {
			Session.set('breadcrumbs', [
				{ title: 'Projects', route: 'projects' },
				{ title: this.params.projectId + "." + this.params.element, route: 'project', id: this.params.projectId },
				{ title: 'Edit Piece' },
			]);
		},
	});
